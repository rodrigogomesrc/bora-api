...
/**
 * REST controller for managing {@link br.ufrn.bora.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public ResponseEntity<LocationDTO> updateLocation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, locationDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<LocationDTO> partialUpdateLocation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, locationDTO.getId())
        );
    }
